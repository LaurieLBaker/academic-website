...
## Creating the icons using `aweomseIconList`
...
After I've created the leaflet map, I need to save the .html and include it as an iframe. The first step is to use `htmlwidgets` and `htmltools` to create a widget. 
...
url_link = "../../static/leaflet/work_map/index.html")
```
